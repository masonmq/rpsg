...
--train_data_file "data/sd/sd_train_ds.csv" \
--dataset "sd" \
--api ${api} \
--noise ${noise} \
...
--train_data_embeddings_file "result/embeddings/${feat_ext}/sd_train_ds.embeddings.npz" \
--r_data ${r_data} \
...
python pii_evaluate.py \
    ...
    --model_input_dir ${train_file}/fd_train_${model} \
