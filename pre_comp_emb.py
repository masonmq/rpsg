...
parser.add_argument("--dataset", type=str, default="yelp",
                    choices=["sd", "yelp", "pubmed", "openreview"],
                    required=False)
...
data_files = {'pubmed': 'data/pubmed/pubmed_ds.csv',
              'yelp': 'data/yelp/train.csv',
              'sd': 'data/sd/sd_train_ds.csv',
...
log_embeddings(all_private_features, all_private_labels[:len(all_private_features)],
               os.path.join('result', 'embeddings', feature_extractor), fname=f'{args.dataset}_train_ds')
