...
PROMPTS_templates = {
    ...
    "init_sd":  {
        "sys_prompt": "Your task is to generate a passage in a tone of a person who is {poor or broke or homeless or unemployment or not being able to afford basic necessities}.",
        "task_desc":  "",
    },
    ...
    "variant_pubmed":  {
        "sys_prompt": "Rephrase the following sentences as an abstract for medical research paper: ",
        "task_desc":  "",  
    },

     "variant_sd":  {
        "sys_prompt": "Your task is to rephrase the following passage in a tone of a person who is {poor or broke or homeless or unemployment or not being able to afford basic necessities}, highlight how their problems affect their lives.",
        "task_desc":  "",
    },
...
SD_INIT_templates = [
    "Write a passage in the tone of a person who is struggling with poverty: ",
    "Write a passage in the tone of a person who is broke: ",
    "Write a passage in the tone of a person who is homeless: ",
    "Write a passage in the tone of a person who is unemployment: ",
    "Write a passage in the tone of a person who is not being able to afford basic necessities: ",
]
...
ALL_SD_styles = ["in a poor tone", "in a needy tone",  "in a pitful style",   "in a begging tone",  "in a helpless tone",
                     ]
