...
PROMPTS_templates = {
    ...
    "init_sd":  {
        "sys_prompt": "Using a variety of sentence structures, write a passage in the tone of a person who is {struggling with poverty or broke or homeless or unemployment or unable to afford basic necessities}.",
        "task_desc":  "",
    },
    ...
    "variant_pubmed":  {
     ...
     "variant_sd":  {
        "sys_prompt": "Rephrase the following passage, highlight how their problems affect their lives:",
        "task_desc":  "",
    },
...
SD_INIT_templates = [
    ...
    "Write a passage in the tone of a person who is unable to afford basic necessities: ",
]
